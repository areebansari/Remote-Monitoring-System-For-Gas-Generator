...
namespace SmsMon
{
    class GenAlarmRow
    {
		...
		public static int C_EXPECTED_FIELD_COUNT = 26;
        ...
        public static int C_HIGHCOOLANTTEMP_INDEX   = 20;
        public static int C_GENOVERSPEED_INDEX      = 21;
        public static int C_GENUNDERSPEED_INDEX     = 22;
        public static int C_FUELTANKLID_INDEX       = 23; 
        public static int C_OILPRESSURE_INDEX       = 24;
        public static int C_OILTEMP_INDEX           = 25;
        ...
        private decimal     f_Coolent_Temp;
        private decimal     f_Over_Speed;     // generator
        private decimal     f_Under_Speed;
        private decimal     f_Fuel_TankLid;
        private decimal     f_Oil_Pressure;
        private decimal     f_OilTemp;
        ...
        public decimal CoolantTemp      { get { return f_Coolent_Temp; } }
        public decimal OverSpeed        { get { return f_Over_Speed; } }
        public decimal UnderSpeed       { get { return f_Under_Speed; } }
        public decimal FuelTankLid      { get { return f_Fuel_TankLid; } }
        public decimal OilPressure      { get { return f_Oil_Pressure; } }
        public decimal OilTemp            { get { return f_OilTemp; } }
        ...
        public GenAlarmRow(String InputRow)
        {
            ...
            string s_HighCoolantTemp  = fields[C_HIGHCOOLANTTEMP_INDEX].Trim();
            string s_GenOverSpeed     = fields[C_GENOVERSPEED_INDEX].Trim();
            string s_GenUnderSpeed    = fields[C_GENUNDERSPEED_INDEX].Trim();
            string s_FuelTankLid      = fields[C_FUELTANKLID_INDEX].Trim();
            string s_OilPressure      = fields[C_OILPRESSURE_INDEX].Trim();
            string s_OilTemp            = fields[C_OILTEMP_INDEX].Trim();
            ...
            try
            {
                 ...
                 f_Coolent_Temp         = Convert.ToDecimal(s_HighCoolantTemp);
                 f_Over_Speed           = Convert.ToDecimal(s_GenOverSpeed);     // generator
                 f_Under_Speed          = Convert.ToDecimal(s_GenUnderSpeed);
                 f_Fuel_TankLid         = Convert.ToDecimal(s_FuelTankLid);
                 f_Oil_Pressure         = Convert.ToDecimal(s_OilPressure);
                 f_OilTemp                = Convert.ToDecimal(s_OilTemp);
